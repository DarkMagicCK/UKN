...
namespace mist {
    ...
    struct MemfunContainer<obj, R(ARGS...)> {
        typedef obj                             obj_type;
        typedef Memfun<obj, R(ARGS...)>         memfun_type;
        typedef typename memfun_type::mem_fun   memfun_ptr;
        
        MemfunContainer(obj_type* object,
                        memfun_ptr func):
        ...
        bool operator == (const MemfunContainer<obj, R(ARGS...)>& rhs) const {
    ...
    struct MemfunContainer<obj, void(ARGS...)> {
        typedef obj                                 obj_type;
        typedef Memfun<obj, void(ARGS...)>          memfun_type;
        typedef typename memfun_type::mem_fun       memfun_ptr;
        ...
        bool operator == (const MemfunContainer<obj, void(ARGS...)>& rhs) const {
            return this->mObj == rhs.mObj && this->mMemfun == rhs.mMemfun;
        }
    ...
    template<typename obj, typename R, typename ...ARGS>
    MemfunContainer<obj, R(ARGS...)> Bind(obj* object, R (obj::*mem_fun)(ARGS...)) {
        return MemfunContainer<obj, R(ARGS...)>(object, mem_fun);
    }
