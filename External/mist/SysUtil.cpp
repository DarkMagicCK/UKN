...
namespace mist {
    ...
    inline MistString ukn_win_get_os_version() {
        OSVERSIONINFO osvi;
    ...
    MistString SystemInformation::GetOSVersion() {
#ifdef MIST_OS_WINDOWS
...
#elif defined(MIST_OS_LINUX) || defined(MIST_OS_OSX)
            {
                ...
                if (supported)
                {
                    ...
                    if (this->testFeature(HTT))
                    {
                        ...
                        {
                            mist_assert(AuthenticAMD == mCPUString);
                    ...
                    if (1 == system_affinity)
                    {
                        ...
                        mist_assert(1 == log_procs_per_pkg);
